...
export default function HeroSlideItem({
  ...
  return (
    <>
        ...
        <div className='absolute flex items-center top-0 left-0 w-full h-full bg-gradient-to-r from-white via-transparent to-transparent'>
          <div className='left-0 w-full p-6 pl-20 text-neutral-900 '>
            <Transition
              ...
              leaveTo='opacity-0'
            >
              <h1 className='text-4xl font-bold font-title'>{title}</h1>
      ...
      <div className='md:hidden flex flex-col w-full h-[100dvh] relative pt-8'>
        <div className='flex items-center w-full  '>
          <div className='left-0 w-full p-6 pl-20 text-neutral-900 '>
            <Transition
              ...
              leaveTo='opacity-0'
            >
              <h1 className='text-4xl font-bold font-title dark:text-slate-200'>
                {title}
              </h1>
              <p className='mt-4 dark:text-slate-200'>{description}</p>
              <div className='mt-6 space-x-4'>
                {buttons.map((button, index) => (
                  <Link
                    key={index}
