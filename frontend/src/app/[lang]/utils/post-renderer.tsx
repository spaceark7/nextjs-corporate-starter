...
import RichTextBlockRenderer from '../components/elements/rich-text-block-renderer/RichTextBlockRenderer'
...
export function postRenderer(section: any, index: number) {
  switch (section.__component) {
    ...
    case 'shared.rich-text-block':
      return <RichTextBlockRenderer key={index} content={section.text} />
    case 'shared.slider':
